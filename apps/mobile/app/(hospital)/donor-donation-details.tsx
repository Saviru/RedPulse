...
export default function DonorDonationDetailsScreen() {
  ...
  const loadDetails = useCallback(async () => {
    ...
    try {
      ...
      alert(`Failed to load donor details: ${getApiErrorMessage(error)}`);
    } finally {
      setLoading(false);
    }
  }, [registrationId]);
  ...
  const onVerifyPrecheck = async () => {
    ...
    try {
      ...
      alert(`Precheck failed: ${getApiErrorMessage(error)}`);
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const onVerifyDoctor = async () => {
    ...
    try {
      ...
      alert(`Doctor verification failed: ${getApiErrorMessage(error)}`);
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const onVerifyFinal = async () => {
    ...
    try {
      ...
      alert(`Final verification failed: ${getApiErrorMessage(error)}`);
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const onCompleteDonation = async () => {
    ...
    try {
      ...
      alert(`Unable to complete donation: ${getApiErrorMessage(error)}`);
    } finally {
      setSubmitting(false);
    }
  };
