...
export default function UserHome2Screen() {
        ...
        <Card variant="elevated" style={[styles.heroCard, { backgroundColor: colors.tint }]}>
          <View style={styles.heroContent}>
            <View style={{ flex: 1, paddingRight: 16 }}>
              ...
              <Button 
                label="Find a donation camp" 
                variant="primary" 
                style={[styles.heroBtnWhite, { marginTop: 12 }]}
                labelStyle={{ color: colors.tint }}
                onPress={() => router.push("/(user)/available-camps" as any)}
              />
            </View>
