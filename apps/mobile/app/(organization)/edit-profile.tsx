...
import { Typo, Input, Button, Avatar, AnimatedHeader } from "@/packages/ui/components/ui";


export default function OrganizationEditProfileScreen() {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.avatarSection}>
          ...
          <Typo variant="caption" color={colors.tint} style={{ marginTop: 12, fontWeight: "500" }}>Tap to change photo</Typo>
        </View>
