            ...
            <>
              <View style={[styles.dummyInput, { backgroundColor: colors.surface }]}>
                <View>
                  ...
                  <Typo variant="body" color={colors.tint} style={{ fontWeight: "500", marginTop: 4 }}>{formData.contact}</Typo>
                </View>
              ...
              <View style={[styles.dummyInput, { backgroundColor: colors.surface }]}>
                <View>
                  ...
                  <Typo variant="body" color={colors.tint} style={{ fontWeight: "500", marginTop: 4 }}>{formData.website}</Typo>
                </View>
        ...
        <View style={styles.detailsSection}>
          <View style={[styles.dummyInput, { backgroundColor: colors.surface, opacity: 0.7 }]}>
            <View>
              ...
              <Typo variant="body" color={colors.textMuted} style={{ fontWeight: "500", marginTop: 4 }}>ORG-2023-SF-0042</Typo>
            </View>
          ...
          <View style={styles.rowInputs}>
            <View style={[styles.dummyInput, { flex: 1, backgroundColor: colors.surface, opacity: 0.7 }]}>
              <View>
                ...
                <Typo variant="body" color={colors.textMuted} style={{ fontWeight: "500", marginTop: 4 }}>Mar 2023</Typo>
              </View>
            </View>
            <View style={[styles.dummyInput, { width: 100, backgroundColor: colors.surface, opacity: 0.7 }]}>
              <View>
                <Typo variant="caption" color={colors.textMuted}>Type</Typo>
                <Typo variant="body" color={colors.textMuted} style={{ fontWeight: "bold", marginTop: 4 }}>NGO</Typo>
              </View>
            </View>
          </View>
