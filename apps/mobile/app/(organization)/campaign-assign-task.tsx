...
import { assignVolunteerTask } from "@/apps/mobile/src/lib/organizationService";
            ...
            {COMMON_ROLES.map((role) => (
              <TouchableOpacity
                ...
                style={[
                  styles.roleChip,
                  {
                    backgroundColor: taskTitle === role ? colors.tint : colors.surface,
                    borderColor: taskTitle === role ? colors.tint : colors.border,
                  },
                ]}
              >
                <Typo
                  variant="caption"
                  style={{
                    color: taskTitle === role ? "#FFF" : colors.text,
                    fontWeight: taskTitle === role ? "700" : "400",
                  }}
                >
                  {role}
                </Typo>
        ...
        <Button
          ...
          onPress={async () => {
            ...
            try {
              ...
              alert(`Assignment failed: ${error instanceof Error ? error.message : String(error)}`);
            } finally {
              setSubmitting(false);
            }
          }}
...
const styles = StyleSheet.create({
  ...
  rolePicker: { marginHorizontal: -20, paddingHorizontal: 20 },
  roleChip: {
