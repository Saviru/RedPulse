...
// Use a local helper or direct extraction instead of getApiErrorMessage
  ...
  useEffect(() => {
    const loadOverview = async () => {
      try {
        ...
        alert(`Failed to load campaign details: ${error instanceof Error ? error.message : String(error)}`);
      } finally {
        setLoading(false);
      }
    };
