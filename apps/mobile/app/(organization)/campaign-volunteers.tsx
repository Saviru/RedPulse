...
export default function CampaignVolunteersScreen() {
  ...
  const loadOverview = useCallback(async () => {
    ...
    try {
      ...
      alert(`Failed to load volunteers: ${getApiErrorMessage(error)}`);
    } finally {
      setLoading(false);
    }
  }, [campaignId]);
  ...
  const markAttendance = async (registrationId: string, status: "ATTENDED" | "ABSENT") => {
    ...
    try {
      ...
      alert(`Failed to update attendance: ${getApiErrorMessage(error)}`);
    } finally {
                    ...
                    <Button
                      ...
                      onPress={async () => {
                        ...
                        try {
                          ...
                          alert(`Failed to remove volunteer: ${getApiErrorMessage(error)}`);
                        } finally {
                          setRejectingId(null);
                        }
                      }}
