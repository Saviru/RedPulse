          ...
          <>
            <View style={styles.menu}>
              ...
              <Typo
                ...
                style={[styles.sectionLabel, { color: colors.textMuted }]}
              >
                Feedback & Community (Phase 1 — local data)
              </Typo>
              <Button
                label="User feedback"
                variant="secondary"
              ...
              />
              <Button
                label="Hospital feedback management"
                variant="secondary"
                onPress={() => router.push("/(hospital)/feedback-management")}
              />
              <Button
                label="Organization feedback management"
                variant="secondary"
                onPress={() => router.push("/(organization)/feedback-management")}
              />
            </View>
          </>
        )}
